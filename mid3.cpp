...
int main(int argc, char *argv[])
{
	...
	if (argc < 3) {
		...
		cout << "                                        \n";
		cout << "Program usage: ./program <mass> <height> or ./program <tolerance>\n";
...
void unit_test(double tolerance)
{
	...
	cout << setw(11) << left << fixed << "mass";
	cout << setw(11) << left << fixed << "height";
	cout << setw(11) << left << fixed << "ponderal";
	cout << setw(11) << left << fixed << "returned" << endl;
	cout << setw(11) << left << fixed << "---------";
	cout << setw(11) << left << fixed << "---------";
	cout << setw(11) << left << fixed << "---------";
	cout << setw(11) << left << fixed << "---------" << endl;
    double diff = 0;
    int errors = 0;
    for(int i=0; i < 480; i += 3) {
	    cout << setw(11) << left << fixed << setprecision(5) << data[i];
	    cout << setw(11) << left << fixed << setprecision(5) << data[i+1];
	    cout << setw(11) << left << fixed << setprecision(5) << data[i+2];
	    cout << setw(11) << left << fixed << setprecision(5) << getPonderal(data[i], data[i+1]);
        // check tolerance
        diff = getPonderal(data[i],data[i+1]) - data[i+2];
